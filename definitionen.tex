...
\end{Sinput}
\begin{Soutput}
 [1]  1  2  2  2  5 10 10 11 11 12 13 13 14 14 14 15 16 17 19 20
\end{Soutput}
\begin{Sinput}
> quantile(x, prob=0.2)
\end{Sinput}
...
\[ \rightarrow Var(Y) = c^2 \cdot Var(X) \]
...
\end{Sinput}
\begin{Soutput}
 [1]  1  3  3  5  7  8  9  9 10 12 12 12 13 13 13 14 14 15 17 17
\end{Soutput}
\begin{Sinput}
> quantile(x, prob=0.2)
\end{Sinput}
...
>>>>>>> 15a15680f1141f4ca056a798e8fb286866fe7566
