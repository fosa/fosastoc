...
<<pixel1, fig=FALSE, echo=FALSE>>=
eps <- 12 # error per screen
X <- ppois(q=c(1:20), lambda=eps)
plot(X, cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5, 
     ylab='', xlab='', main='ppois()')
@

<<pixel2, fig=FALSE, echo=FALSE>>=
eps <- 12 # error per screen
Y <- (1-ppois(q=c(0:19), lambda=eps))
plot(Y, cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5, 
     ylab='', xlab='', main='dpois()')
@
...
plot(X, cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5, 
     ylab='P(X=x)', xlab='Anzahl Requests', main='dpois()')
@
...
plot(X, cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5, 
     ylab='P(X<=x)', xlab='Anzahl Requests', main='ppois()')
abline(h=(1-ppois(q=(15-1), lambda=hpw)))
@
...
<<embedded3, fig=FALSE, echo=FALSE>>=
hpd <- 2
hpw <- hpd*7
X <- ppois(q=c(1:30), lambda=hpw)
plot(X, cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5, 
     ylab='', xlab='', main='ppois()')
abline(h=0.5)
@
...
\centering
\includegraphics[width=0.9\textwidth]{../fig/lintrans.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{../fig/dichtefunktion.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{../fig/dichtefunktion-quantile.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{../fig/uniform.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.95\textwidth]{../fig/adc-system.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{../fig/normal.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{../fig/jitter.pdf}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\textwidth]{../fig/exponential.pdf}
...
<<dexp, fig=FALSE, echo=FALSE>>=
plot(dexp(x=seq(0, 10, 0.001), rate=1), type='l', cex.lab=1.5, 
     cex.axis=1.5, cex.main=1.5, cex.sub=1.5, 
     ylab='P(x)', xlab='Wert x', 
     main='dexp()')
@

<<pexp, fig=FALSE, echo=FALSE>>=
plot(pexp(q=seq(0, 10, 0.001), rate=1), type='l', cex.lab=1.5, 
     cex.axis=1.5, cex.main=1.5, cex.sub=1.5, 
     ylab='P(X<=x)', xlab='Wert x', 
     main='pexp()')
@

<<qexp, fig=FALSE, echo=FALSE>>=
plot(qexp(p=seq(from=0, to=1, by=0.001), rate=1), type='l',
     cex.lab=1.5, cex.axis=1.5, cex.main=1.5, cex.sub=1.5, ylab='Wert x', 
     xlab='Quantil in Promille', main='qexp()')
@

<<rexp, fig=FALSE, echo=FALSE>>=
plot(rexp(n=100, rate=1), cex.lab=1.5, cex.axis=1.5, 
     cex.main=1.5, cex.sub=1.5, ylab='Wert x', xlab='x-te Zahl', 
     main='rexp()')
@
